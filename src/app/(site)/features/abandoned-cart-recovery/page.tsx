...
import {
  ...
  Hero,
  Testimonials,
} from "@/components/features/abandoned-cart-recovery";
...
const SLUG = "abandoned-cart-recovery";
...
/**
 * Abandoned Cart Recovery (§6.3).
 *
 * The fourth feature page, and a composition file and nothing more: every
 ...
 * how it runs (flow), proof that it runs (demo), what the merchant gets
 * (features), who it suits (audience), who else uses the product
