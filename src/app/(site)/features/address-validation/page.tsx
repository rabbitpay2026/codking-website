...
import {
  ...
  Hero,
  Testimonials,
} from "@/components/features/address-validation";
...
export function generateMetadata(): Metadata {
  ...
  return createMetadata({
    title: `${control.name} for Shopify COD checkout`,
 ...
 * worse than no video. The hero's scene shows the filled checkout instead.
 *
