...
export function CheckoutScreen() {
  return (
    <div className="flex size-full flex-col bg-white text-ink">
      ...
      <p className="mt-3 px-4 text-[8.5px] font-semibold tracking-[0.1em] text-ink/35 uppercase">
        Deliver to
      </p>
      ...
      */}
      ...
      <div className="mt-1.5 space-y-1.5 px-4">
        ...
        <div className="rounded-xl border-2 border-brand bg-brand-soft/70 p-2.5">
          ...
          <div className="mt-2 rounded-lg bg-white/85 p-2">
            <div className="flex items-center justify-between">
              <span className="text-[9px] font-semibold text-brand">
                Pay ₹300 now
              </span>
              <span className="text-[8px] text-ink/45">₹1,048 on delivery</span>
            </div>
            <div className="mt-1.5 h-1 overflow-hidden rounded-full bg-ink/10">
              <div className="h-full w-[22%] rounded-full bg-brand" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-auto px-4 pt-2">
        ...
        <div className="mt-2 mb-3 flex h-9 items-center justify-center gap-1 rounded-full bg-brand text-[11px] font-semibold text-white shadow-[0_6px_16px_-6px_var(--brand)]">
          Complete order
