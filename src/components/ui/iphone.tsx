...
export function Iphone({
  ...
  return (
    ...
    >
      {/* Titanium rail. */}
      <div
        className="absolute inset-0 rounded-[15.5%/7.6%] p-[1.7%]"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute inset-[0.6%] rounded-[15%/7.4%] opacity-70"
          style={{
            backgroundImage:
        ...
        <div className="relative size-full rounded-[14.1%/7%] bg-[#0d0a1c] p-[1.2%]">
          {/* Glass. */}
          <div className="@container relative size-full overflow-hidden rounded-[13%/6.4%] bg-white">
            {/*
            ...
            */}
            ...
            <div
              aria-hidden
              className="absolute top-[1.4%] left-1/2 h-[3.2%] w-[29%] -translate-x-1/2 rounded-full bg-[#0d0a1c]"
            >
            ...
            <div
              aria-hidden
              className="pointer-events-none absolute inset-0 rounded-[13%/6.4%] shadow-[inset_0_0_2px_rgba(20,16,58,0.4)]"
            />
          </div>
        </div>
      </div>
      ...
      <span
        aria-hidden
        className="absolute top-[8.5%] -left-[0.2%] h-[0.5%] w-[2.4%] rounded-full bg-[#6f6a80]/70"
      />
      <span
        aria-hidden
        className="absolute bottom-[8.5%] -left-[0.2%] h-[0.5%] w-[2.4%] rounded-full bg-[#6f6a80]/70"
      />

      {/* Side buttons, lit by the same source as the rail. */}
      <div
        aria-hidden
        className="absolute top-[16.5%] -left-[0.9%] h-[3.6%] w-[1.1%] rounded-l-[2px] bg-gradient-to-r from-[#7f7a8e] via-[#cbc7d8] to-[#a29daf]"
      />
      <div
        aria-hidden
        className="absolute top-[23.5%] -left-[0.9%] h-[6.8%] w-[1.1%] rounded-l-[2px] bg-gradient-to-r from-[#7f7a8e] via-[#cbc7d8] to-[#a29daf]"
      />
      <div
        aria-hidden
        className="absolute top-[32.5%] -left-[0.9%] h-[6.8%] w-[1.1%] rounded-l-[2px] bg-gradient-to-r from-[#7f7a8e] via-[#cbc7d8] to-[#a29daf]"
      />
      <div
        aria-hidden
        className="absolute top-[25%] -right-[0.9%] h-[10.5%] w-[1.1%] rounded-r-[2px] bg-gradient-to-l from-[#7f7a8e] via-[#cbc7d8] to-[#a29daf]"
      />
    </div>
  );
}
