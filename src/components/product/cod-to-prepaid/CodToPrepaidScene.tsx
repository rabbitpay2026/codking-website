...
const CONTROLS: readonly { id: string; icon: LucideIcon; label: string }[] = [
  {
    id: "rules",
    icon: Percent,
    label: "Discount rules — % or fixed value",
  },
  {
    id: "prepaid-only",
    icon: Wallet,
 ...
 * discount is configured rather than fixed.
 *
 ...
 */
export function CodToPrepaidScene({ className }: WithClassName) {
  return (
    <div className={cn("relative w-full", className)}>
      ...
      <div className="flex items-center gap-4">
        <CodToPrepaidPanel className="mx-auto w-full max-w-[23rem] lg:mx-0 lg:max-w-none lg:flex-1" />
