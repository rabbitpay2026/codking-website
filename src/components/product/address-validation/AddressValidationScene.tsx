import { History, PenLine, Smartphone } from "lucide-react";
...
const CONTROLS: readonly { id: string; icon: LucideIcon; label: string }[] = [
  { id: "phone", icon: Smartphone, label: "Matched on their number" },
  { id: "history", icon: History, label: "Reused from past orders" },
  { id: "editable", icon: PenLine, label: "Still editable at checkout" },
];
  ...
  return (
    <div className={cn("relative w-full", className)}>
      ...
      <div className="flex items-center gap-4">
        <AddressPanel className="mx-auto w-full max-w-[23rem] lg:mx-0 lg:max-w-none lg:flex-1" />
