...
const CONTROLS: readonly { id: string; icon: LucideIcon; label: string }[] = [
  { id: "controls", icon: SlidersHorizontal, label: "Every control reports" },
  { id: "range", icon: CalendarRange, label: "Trends over time" },
  { id: "place", icon: LayoutDashboard, label: "One place to look" },
];
  ...
  return (
    <div className={cn("relative w-full", className)}>
      ...
      <div className="flex items-center gap-4">
        <ReportPanel className="mx-auto w-full max-w-[23rem] lg:mx-0 lg:max-w-none lg:flex-1" />
