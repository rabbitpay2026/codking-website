 ...
 *
 * The relay sits beside them rather than in the hero. It answers the question
 * the two cards raise — if the operator bills me and COD King bills me, what
 * is COD King actually doing? — so it belongs in the same glance as the
 * answer, not four bands earlier.
 */
export function PaymentModel() {
  ...
  return (
    <SectionShell size="compact" className="border-t border-ink/[0.07]">
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1.18fr)] lg:items-center lg:gap-10">
        <OperatorRelay className="mx-auto max-w-[23rem] lg:mx-0 lg:max-w-none" />

        <ul className="grid items-stretch gap-4 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
