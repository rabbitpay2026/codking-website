...
import { getCodShowHidePageCopy } from "@/lib/content";
 ...
 *
 * The mark is the one the homepage board and the Features index already use
 * for this control, so a merchant who arrived from either recognises what they
 * clicked.
 */
export function Cta() {
  return (
    <FeatureCtaBand
      title={getCodShowHidePageCopy().ctaTitle}
