/**
 * The COD Show/Hide page, section by section.
 *
 ...
 * `CodShowHideHero`. The folder already says which page these belong to, and
 * the route file imports the whole set from this one module, so the prefix
 * would be repeated nine times to disambiguate nothing.
 */
