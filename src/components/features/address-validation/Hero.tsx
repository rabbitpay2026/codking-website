...
import { AddressValidationScene } from "@/components/product/address-validation";
import { getAddressCheckpoints, getAddressPageCopy } from "@/lib/content";

/**
 * The top of the Prefilled Address page.
 *
