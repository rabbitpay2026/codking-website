 ...
 * The close.
 *
 * The OTP page's band, unchanged but for its headline — same panel, same
 * treatment, same two actions the header has carried since the visitor
 ...
 */
export async function PartialPaymentCta() {
