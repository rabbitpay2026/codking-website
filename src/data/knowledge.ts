...
export const controlKnowledge: Partial<Record<ControlSlug, ControlKnowledge>> =
  {
    ...
    "cod-to-prepaid": {
      overview: [
        ...
        "The discount rules are fully configurable: a percentage of the cart or a fixed value, with the merchant's own wording and their own conditions for when it applies. Flexible tax options let a merchant manage different tax structures across regions and compliance requirements on the discounted order. Conversion from cash on delivery to prepaid is tracked in real time inside the app.",
      ...
      configuration: [
        ...
        {
          id: "tax",
          option: "Tax structure",
          detail:
            "Flexible tax options covering multiple regions and compliance requirements on a discounted order.",
        },
        {
          id: "tracking",
          option: "Reporting",
